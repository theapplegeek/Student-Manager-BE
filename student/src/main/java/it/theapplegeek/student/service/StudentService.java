...
import it.theapplegeek.student.feign.EnrolmentFeignClient;
...
public class StudentService {
  ...
  @Autowired private StudentCardFeignClient studentCardClient;
        ...
        .map(
            (student) -> {
              StudentCardDto studentCardDto =
                  studentCardClient.getStudentCardByStudentId(student.getId());
  ...
  @Caching(evict = {@CacheEvict(cacheNames = "student", key = "#studentId")})
  @Transactional
  ...
  public void deleteStudent(Long studentId) {
    ...
    enrolmentFeignClient.deleteEnrolmentByStudent(studentId);
    log.info("##### Enrolment of student with id " + studentId + " deleted #####");
