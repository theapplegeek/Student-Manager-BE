...
public class StudentCardController {
  ...
  @Autowired private StudentCardService studentCardService;
  ...
  public StudentCardDto getStudentCardByStudentId(@PathVariable("studentId") Long studentId) {
    log.info(
        "##### GET getStudentCardByStudentId -> get student card of student with id "
            + studentId
            + " #####");
  ...
  public StudentCardDto addStudentCardAndAssignToStudent(
      @PathVariable("studentId") Long studentId,
      @Valid @RequestBody StudentCardDto studentCardDto) {
    log.info(
        "##### POST addStudentCardAndAssignToStudent -> add student card of student with id "
            + studentId
            + " #####");
    log.info(
        "##### studentCardDto: \n"
  ...
  @PutMapping("{cardId}")
  public StudentCardDto updateStudentCard(
      @PathVariable("cardId") Long cardId,
      @RequestParam(value = "isRenewal", required = false, defaultValue = "false")
          Boolean isRenewal,
    ...
    log.info(
        "##### studentCardDto: \n"
            + jsonUtils.convertObjectToPrettyJson(studentCardDto)
            + "\n#####");
    StudentCardDto studentCardUpdated = studentCardService.updateStudentCard(cardId, studentCardDto, isRenewal);
    log.info("##### Student card with id " + studentCardUpdated.getId() + " updated #####");
    return studentCardUpdated;
  }

  @DeleteMapping("{cardId}")
  public void deleteStudentCard(@PathVariable("cardId") Long cardId) {
    log.info(
        "##### DELETE deleteStudentCard -> delete a student card with id " + cardId + " #####");
  ...
  public void deleteStudentCardByStudentId(@PathVariable("studentId") Long studentId) {
    log.info(
        "##### DELETE deleteStudentCard -> delete a student card of student with id "
            + studentId
            + " #####");
